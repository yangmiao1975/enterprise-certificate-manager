      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl h-5/6 flex flex-col">
        ...
        <div className="flex items-center justify-between p-4 border-b">
          <div className="flex items-center space-x-2">
            <h2 className="text-xl font-semibold">Certificate AI Assistant</h2>
            {dbContext && (
        ...
        <div className="p-4 border-b bg-gray-50">
          <div className="flex flex-wrap gap-2">
            <button
              ...
              disabled={isLoading}
              className="px-3 py-1 text-sm bg-yellow-100 text-yellow-800 rounded hover:bg-yellow-200 disabled:bg-gray-100"
            >
            ...
            <button
              ...
              disabled={isLoading}
              className="px-3 py-1 text-sm bg-blue-100 text-blue-800 rounded hover:bg-blue-200 disabled:bg-gray-100"
            >
              Best Practices
            </button>
            {selectedCertificateId && (
              <button
                ...
                disabled={isLoading}
                className="px-3 py-1 text-sm bg-purple-100 text-purple-800 rounded hover:bg-purple-200 disabled:bg-gray-100"
              >
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          {messages.length === 0 && (
            <div className="text-center text-gray-500 mt-8">
              <div className="text-lg mb-2">👋 Hi! I'm your Certificate AI Assistant</div>
