...
interface UploadCertificateFormProps {
  onSubmit: (file: File, folderId: string | null) => Promise<void>; // Updated onSubmit
  onCancel: () => void;
...
const UploadCertificateForm: React.FC<UploadCertificateFormProps> = ({ onSubmit, onCancel, folders }) => {
  ...
  const [selectedFolderId, setSelectedFolderId] = useState<string | null>(null); // New state for folder selection
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsUploading(true);
    try {
      await onSubmit(selectedFile, selectedFolderId); // Pass selectedFolderId
